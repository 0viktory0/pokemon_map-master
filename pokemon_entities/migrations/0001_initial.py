# Generated by Django 3.1.14 on 2022-11-30 12:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_jp', models.CharField(blank=True, max_length=200, verbose_name='Название на китайском')),
                ('description', models.TextField(blank=True, verbose_name='Описание')),
                ('image', models.ImageField(null=True, upload_to='', verbose_name='Изображение')),
                ('previous_evolution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='next_evolution', to='pokemon_entities.pokemon', verbose_name='Эволюция покемона')),
            ],
        ),
        migrations.CreateModel(
            name='PokemonEntity',
